...
public abstract class ModalDialogBase extends JDialog {

  protected JPanel contentPanel;

  protected JPanel buttonPanel;

  protected DialogOperation selectedOperation;

  protected DialogOperationAction[] actions;
  ...
  public ModalDialogBase(Frame owner, String title) {
    super(owner, title, true);
    initialize();
    setLocationRelativeTo(owner);
  }

  public ModalDialogBase(Dialog owner, String title) {
    super(owner, title, true);
    initialize();
    setLocationRelativeTo(owner);
  }
