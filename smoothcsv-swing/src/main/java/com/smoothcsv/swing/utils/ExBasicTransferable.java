...
public class ExBasicTransferable implements Transferable, UIResource {
  ...
  public ExBasicTransferable(String plainData, String htmlData) {
  ...
  /**
   * Should the plain text flavors be offered? If so, the method getPlainData should be implemented
